...
Here you will find Xaringan presentations illustrating various tricks and tips for working in R.

Import Data to R is the first big hurdle when dealing with data in R. You are most likely to have looked at, organised and examined your data files in Excel. Here is a compendious Xaringan presentation showing how to import .csv and .xlsx data files into R that will help you get going.

 - Import csv and Excel spreadsheet data files:

https://importdata2r.netlify.app

Plotting time series could be a tricky task. Here are a few tips that will help you add the reference time points to enrich your time series visualisation. 
