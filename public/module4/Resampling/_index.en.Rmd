...
The bootstrap method was introduced by [Efron in 1979](http://jeti.uni-freiburg.de/studenten_seminar/stud_sem_SS_09/EfronBootstrap.pdf). Since then it has evolved considerably. Due to its intuitive nature, easily grasped by practitioners and available strong computational power necessary for its application, today the bootstrapping is regarded as the indispensable tool for data analysis. The method is named after [Baron Münchhausen](https://en.wikipedia.org/wiki/Baron_Munchausen), a fictional character who in one of the stories has saved his life by pulling himself out of the bottom of a deep lake by his own hair.
