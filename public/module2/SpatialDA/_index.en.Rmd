...
Here is an interesting website which introduces all kind of possibilities when creating maps with ['leaflet'](https://maptimeboston.github.io/leaflet-intro/). You should check it out and explore further for yourself.
